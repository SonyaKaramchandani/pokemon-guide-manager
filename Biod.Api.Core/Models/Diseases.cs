...
namespace Biod.Api.Core.Models
{
    public partial class Diseases
    {
        ...
        public decimal? SymptomaticAverageDays { get; set; }
        public decimal? SymptomaticMinimumDays { get; set; }
        public decimal? SymptomaticMaximumDays { get; set; }
        public string BiosecurityRisk { get; set; }
        public int? OutbreakPotentialAttributeId { get; set; }

        public BiosecurityRisk BiosecurityRiskNavigation { get; set; }
