...
AS
SELECT        zebra.Xtbl_User_Disease_Relevance.UserId, dbo.UserProfile.Email AS UserEmail, disease.Diseases.DiseaseId, disease.Diseases.DiseaseName, zebra.RelevanceType.RelevanceId, 
...
FROM            dbo.UserProfile INNER JOIN
                         zebra.Xtbl_User_Disease_Relevance ON dbo.UserProfile.Id = zebra.Xtbl_User_Disease_Relevance.UserId INNER JOIN
