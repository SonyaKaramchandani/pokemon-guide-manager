...
BEGIN
	...
	Begin
		...
		Set @minIncubation=(Select [IncubationMinimumSeconds] From [disease].DiseaseSpeciesIncubation Where DiseaseId=@diseaseId and SpeciesId=1)
		Set @maxIncubation=(Select IncubationMaximumSeconds From [disease].DiseaseSpeciesIncubation Where DiseaseId=@diseaseId and SpeciesId=1)
		Set @avgIncubation=(Select IncubationAverageSeconds From [disease].DiseaseSpeciesIncubation Where DiseaseId=@diseaseId and SpeciesId=1)
		--str
