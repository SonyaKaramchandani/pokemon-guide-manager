...
-- Author:		Basam Ahmad
-- Create date: 2018-05 
-- Description:	Input: DiseaseId
--				Output: List of event information
--				For Zebra external API, ZebraEventsDisease_Get
-- 2019-07 name changed
-- 2019-09: disease schema change
-- =============================================
CREATE PROCEDURE zebra.usp_ZebraApiGetEventsByDiseaseId
	@DiseaseId INT
AS
BEGIN
	SELECT  
	...
	WHERE f1.SpeciesId=1 and DTM.SpeciesId=1 and
		E.IsPublished = 1 AND E.EndDate IS Null AND D.DiseaseId = @DiseaseId
END