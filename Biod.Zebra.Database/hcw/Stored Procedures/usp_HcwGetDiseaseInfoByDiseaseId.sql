...
-- Author:		Vivian
-- Create date: 2019-03 
-- Description:	This is a copy of usp_ZebraEventGetDiseaseByEventId
--				Except the input DiseaseId instead of EventId and the first line of code
-- 2019-09: disease schema change
-- =============================================
CREATE PROCEDURE hcw.usp_HcwGetDiseaseInfoByDiseaseId
	@DiseaseId INT
AS
BEGIN
	SET NOCOUNT ON;
