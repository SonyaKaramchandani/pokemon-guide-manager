...
namespace Biod.Zebra.Api.LocalFeed
{
    public class ZebraGeonameShapesAsTextController : BaseApiController
    {
        ...
        public List<ShapeAsTextModel> Get(string GeonameIds = "")
        {
            ...
            var sqlCommand = $"Select ag.GeonameId, ag.LocationType, cps.SimplifiedShape.STAsText() as Shape, ag.Longitude, ag.Latitude From [place].[CountryProvinceShapes] cps right JOIN place.ActiveGeonames ag ON ag.GeonameId = cps.GeonameId WHERE ag.GeonameId IN ({geonameIdsParam})";
