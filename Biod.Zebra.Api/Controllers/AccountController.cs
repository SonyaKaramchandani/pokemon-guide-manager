...
namespace Biod.Zebra.Api.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //    UserManager.AddToRole(userId, ConfigurationManager.AppSettings.Get("UnsubscribedUsersRole"));
        //    return View();
        //}
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    model.Location = zebraDbContext.usp_ZebraPlaceGetLocationNameByGeonameId(model.GeonameId).FirstOrDefault();
                }
