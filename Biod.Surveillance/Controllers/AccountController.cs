...
namespace Biod.Surveillance.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            //............
            //TempData["ArticleCount"] = await Task.Run(() => ArticleCount.GetAllArticleCount());
            //TempData["EventList"] = await Task.Run(() => EventRoot.GetAllEvents());
            //BiodSurveillanceDataEntities db = new BiodSurveillanceDataEntities();
            //TempData["ArticleListInitial"] = db.usp_GetParentArticleList("all", 0, 50, "").ToList();
            //.............
        ...
        [AuthorizeByConfig(RolesAppSettingKey = "PowerUsersRole")]
        //[AllowAnonymous]
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                userManager.AddToRole(user.Id, ConfigurationManager.AppSettings.Get("UsersRole"));
