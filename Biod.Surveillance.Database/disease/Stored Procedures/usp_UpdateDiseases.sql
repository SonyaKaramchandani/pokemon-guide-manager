...
-- Output: inserted into 10 tables: [Diseases]/AgentTypes/TransmissionModes Agents/Interventions/Xtbl_Disease_Agents/Xtbl_Disease_Interventions
...
BEGIN
	...
	BEGIN TRAN
		...
		Declare @tbl_Diseases table ([DiseaseId] int, [DiseaseName] nvarchar(100), Pronunciation varchar(100), 
			...
			[DiseaseType] varchar(200), IsZoonotic bit);
