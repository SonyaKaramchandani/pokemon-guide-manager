namespace Biod.Insights.Service.Models.HealthCareWorker.DataSystemsApiModels
{
    ...
    public class RefinementByActivitiesAndVaccinesQuestionModel
    {
        ...
        [Newtonsoft.Json.JsonProperty("vaccines", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<VaccineModel> DiseasesWithVaccines { get; set; }
    }
}