namespace Biod.Insights.Service.Models.HealthCareWorker.DataSystemsApiModels
{
    ...
    public class HealthCareWorkerModel
    {
        ...
        public bool? HasSeasonalityData { get; set; }
        ...
        /// <summary>Magnitude/weight of modifier on the disease during offSeason, (float)</summary>
        ...
        [Newtonsoft.Json.JsonProperty("minimumDays", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? MinimumDays { get; set; }

        /// <summary>Approximate maximum number of days for disease incubation to end, (float)</summary>
        [Newtonsoft.Json.JsonProperty("maximumDays", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double? MaximumDays { get; set; }

        /// <summary>Approximate average number of days for disease incubation to last, (float)</summary>
        [Newtonsoft.Json.JsonProperty("averageDays", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// <summary>Indicates on the symptom onset date, how many days it has been from the incubation period. Negative value means days before min incubation starts. 0 means within incubation criteria. Positive value means days after the max incubation period, (float)</summary>
        ...
        [Newtonsoft.Json.JsonProperty("isEndemic", Required = Newtonsoft.Json.Required.Always)]
        public bool IsEndemic { get; set; }

        /// <summary>Indicates whether the disease is a disease outbreak event in the region</summary>
        [Newtonsoft.Json.JsonProperty("isDiseaseEvent", Required = Newtonsoft.Json.Required.Always)]
        ...
        /// <summary>A HCW value that shows indicates the risk and probability of getting a disease, calculated by multiplying diseasePrevalence, offSeasonWeight (if off season), hcwModelWeight, rank1MaxAcquisitionMultiplier together, (float)</summary>
        ...
        /// <summary>A tiering system for syndromes, values from 1-3, (int)</summary>
        [Newtonsoft.Json.JsonProperty("syndromeTier", Required = Newtonsoft.Json.Required.Always)]
        public int SyndromeTier { get; set; }

        /// <summary>A tiering system for HCW, values from 1-4, tier 1-3 is the same as syndromeTier 1-3, tier 4 means disease that are not within incubation criteria, (int)</summary>
