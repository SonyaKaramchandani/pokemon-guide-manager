...
const sampleContent = (
  <>
    ...
    <p>
      <b>Confirmed cases</b> are either laboratory confirmed or meet the clinical definition and are
...
export const test2 = () => (
  <div style={{ width: 370, padding: '10px' }}>
    <Accordian title="Disease Information">{sampleContent}</Accordian>
    <Accordian title="Disease Information">{sampleContent}</Accordian>
    <Accordian title="Disease Information">{sampleContent}</Accordian>
    <Accordian title="Disease Information">{sampleContent}</Accordian>
  </div>
...
export const testSticky = () => (
  <div style={{ width: 370, padding: '10px' }}>
    <Accordian title="Disease Information" sticky expanded>{sampleContent}</Accordian>
    <Accordian title="Disease Information" sticky expanded>{sampleContent}</Accordian>
    <Accordian title="Disease Information" sticky expanded>{sampleContent}</Accordian>
    <Accordian title="Disease Information" sticky expanded>{sampleContent}</Accordian>
    <Accordian title="Disease Information" sticky expanded>{sampleContent}</Accordian>
